...
import 'package:admin_side/admin/front/adminfront.dart';
import 'package:admin_side/user/login/widgets/custom_clippers/brown_top_clipper.dart';
import 'package:admin_side/user/login/widgets/custom_clippers/gold_top_clipper.dart';
import 'package:admin_side/user/login/widgets/custom_clippers/lightgold_top_clipper.dart';
                        ...
                        ConstrainedBox(
                          ...
                          child: TextButton(
                            ...
                            onPressed: ()
                            {
                              ...
                              // if(mobileno.text.toString()=="7897897890" && password.text.toString()=="1234")
                              // {
                              //   sharedPreferences.setBool('ewishesadmin', false);
                              //   sharedPreferences.setString('uname', mobileno.text.toString());
